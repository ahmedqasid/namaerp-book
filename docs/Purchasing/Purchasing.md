...
الاعتماد المستندي هو تعهد مكتوب من بنك المشتري بالدفع لبنك البائع مبلغًا محددًا من المال نيابة عن المشتري، وذلك بشرط أن يقدم البائع المستندات المطلوبة التي تثبت أنه قد قام بتنفيذ التزاماته وفقًا للعقد (مثل بوليصة الشحن، وفاتورة الشحن، وشهادة المنشأ).
في نظام المشتريات، يعمل الاعتماد المستندي كآلية لحماية الطرفين:
للمشتري: يوفر ضمانًا بأن أمواله لن تُدفع إلا بعد تقديم المستندات الصحيحة التي تثبت شحن البضائع.
للبائع: يضمن له استلام أمواله من بنك موثوق (بنك المشتري)، مما يقلل بشكل كبير من مخاطر عدم الدفع.
