...
> **⚠️ تحذير مهم جداً**: بمجرد حدوث أي حركة (توريد أو صرف) على الصنف، **لا يمكن تغيير إعدادات متابعة الكميات أو التكاليف** لهذا الصنف
...
- **ضمان الدقة**: هذا يضمن أن تكون **تقاريرك المالية دقيقة**، حتى لو تم اكتشاف الأخطاء بعد فترة طويلة

#### لماذا يسمح النظام بذلك؟
- **الهدف الأساسي**: القدرة على **تصحيح الأخطاء** التي قد يرتكبها المستخدمون في إدخال البيانات:
  - إدخال سعر خاطئ
  - إدخال كمية خاطئة
  - أخطاء بيانات أخرى

- **الاستخدامات المحتملة**: رغم أنها قد تستخدم لأغراض أخرى (مثل التلاعب الضريبي)، فإن النظام يوفر الأداة بناءً على **طلب العملاء** لمرونة تصحيح الأخطاء التشغيلية

> **ملاحظة**: افتراضيًا، النظام **يمنع التعديل** على الحركات القديمة، لكن يمكن **تفعيل هذا الخيار** بناءً على طلب العميل
